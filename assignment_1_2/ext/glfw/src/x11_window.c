                                     ...
                                     int* right, int* bottom)
{
        ...
        _glfw.x11.NET_REQUEST_FRAME_EXTENTS)
    {
        ...
        //       listed above, PLEASE report1 it to their and our issue trackers
                              ...
                              (XPointer) window))
        {
            ...
            if (remaining <= 0.0)
            {
                _glfwInputError(GLFW_PLATFORM_ERROR,
                                "X11: The window manager has a broken _NET_REQUEST_FRAME_EXTENTS implementation; please report1 this issue");
                return;
            }
